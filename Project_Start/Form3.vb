...
Public Class Scedule
    ...
    Private Sub Scedule_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cnn.ConnectionString = "Data Source=DESKTOP-14S1VPU\SQLEXPRESS;Initial Catalog=Project1;Integrated Security=True"
        cnn.Open()
        dap = New SqlDataAdapter("SELECT Train_No,Name,Dept FROM Schedule", cnn)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles MrInfBtn.Click
        If TextBox1.Text = Nothing Then
            MsgBox("You have not entered any train number")
        Else
            Me.Hide()
            Information.Show()
        End If
